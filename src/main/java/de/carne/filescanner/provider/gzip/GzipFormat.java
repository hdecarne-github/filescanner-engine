...
/**
 * <a href="https://en.wikipedia.org/wiki/Gzip">Gzip file format</a> decoder.
 */
public class GzipFormat extends Format {
	...
	/**
	 * Constructs a new {@linkplain GzipFormat} instance.
	 */
	public GzipFormat() {
		super(FORMAT_NAME);
		this.formatSpecDefinition = new GzipFormatSpecDefinition();
