...
/**
 * <a href="https://en.wikipedia.org/wiki/PDF">PDF file format</a> decoder.
 */
public class PdfFormat extends Format {

	private static final String FORMAT_NAME = "PDF file";

	private final PdfFormatSpecDefinition formatSpecDefinition;

	/**
	 * Constructs a new {@linkplain PdfFormat} instance.
	 */
	public PdfFormat() {
		super(FORMAT_NAME);
		this.formatSpecDefinition = new PdfFormatSpecDefinition();
