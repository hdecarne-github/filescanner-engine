...
/**
 * {@linkplain AttributeRenderer} used for rendering of Apple date values.
 */
public class AppleDateRenderer implements AttributeRenderer<Integer> {
	...
	/**
	 * Renders the given Apple date value.
	 *
	...
	public void render(RenderOutput out, int value) throws IOException {
		out.setStyle(RenderStyle.COMMENT).write(" // ").write(Apple.appleDateToLocalDateTime(value).toString());
	}
