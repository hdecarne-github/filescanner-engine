...
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.AttributeValidateNumberModifierContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.AttributeValidateStringModifierContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.ByteArrayAttributeSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.ByteAttributeSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.ByteFlagSymbolsContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.ByteSymbolsContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.CharArrayAttributeSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.CompositeSpecByteOrderModifierContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.CompositeSpecExportModifierContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.CompositeSpecExpressionContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.CompositeSpecRendererModifierContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.ConditionalCompositeSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.ConditionalSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.DecodeAtSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.DwordArrayAttributeSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.DwordAttributeSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.DwordFlagSymbolsContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.DwordSymbolsContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.EncodedInputSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.ExternalReferenceContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.FlagSymbolsContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.FormatSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.FormatSpecsContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.FormatTextArgumentContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.FormatTextContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.NumberArrayValueContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.NumberArrayValueSetContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.NumberExpressionContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.NumberValueContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.NumberValueSetContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.QwordArrayAttributeSpecContext;
...
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.SequenceSpecMinModifierContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.SequenceSpecSizeModifierContext;
...
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.StringAttributeSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.StructSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.StructSpecElementContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.SymbolDefinitionContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.SymbolsContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.TextExpressionContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.UnionSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.ValidationTextContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.ValidationTextSetContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.WordArrayAttributeSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.WordAttributeSpecContext;
import de.carne.filescanner.engine.format.grammar.FormatSpecGrammarParser.WordFlagSymbolsContext;
...
public abstract class FormatSpecDefinition {
	...
	/**
	 * Adds a string {@linkplain AttributeFormatter}.
	 *
	 * @param identifier the formatter identifier.
	 * @param formatter the {@linkplain AttributeFormatter} to add.
	 * @return the update {@linkplain FormatSpecDefinition}.
	...
	public FormatSpecDefinition addStringAttributeFormatter(String identifier, AttributeFormatter<String> formatter) {
		if (this.stringAttributeFormatter.put(identifier, formatter) != null) {
			LOG.warning("Redefinition of string attribute formatter ''{0}''", identifier);
		}
		return this;
	}
	...
	/**
	 * Adds a string {@linkplain AttributeRenderer}.
	 *
	 * @param identifier the renderer identifier.
	 * @param renderer the {@linkplain AttributeRenderer} to add.
	 * @return the update {@linkplain FormatSpecDefinition}.
	...
	public FormatSpecDefinition addStringAttributeRenderer(String identifier, AttributeRenderer<String> renderer) {
		if (this.stringAttributeRenderer.put(identifier, renderer) != null) {
			LOG.warning("Redefinition of string attribute renderer ''{0}''", identifier);
		}
		return this;
	}
	...
	private CharArraySpec loadCharArraySpec(CharArrayAttributeSpecContext specCtx, FormatSpecsContext rootCtx) {
		...
		applyFormatModifier(spec, specCtx.attributeFormatModifier(), this.stringAttributeFormatter);
		applyRendererModifier(spec, specCtx.attributeRendererModifier(), this.stringAttributeRenderer);
		bindAttributeSpecIfNeeded(spec, specCtx.specIdentifier(), specCtx.scopeIdentifier(), rootCtx);
