 ...
 *
 * @param <T> The actual number attribute type.
 */
public abstract class NumberAttributeSpec<T extends Number> extends AttributeSpec<T> {

	/**
	 * Constructs a new {@linkplain NumberAttributeSpec} instance.
	 *
